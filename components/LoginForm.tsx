...
export function LoginForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-[460px] px-6 py-9 sm:px-9 sm:py-11">
      ...
      {next === "/cart" && (
        <p className="mt-4 rounded-card border border-trust/30 bg-trust/5 px-3 py-2 text-sm text-ink">
          Sign in to check out. Everything in your cart comes with you.
        </p>
      )}

      {urlError && (
        <p className="spec mt-4 rounded-lg border border-deal bg-deal-soft px-3 py-2 text-deal">
      ...
      <div className="mt-6 space-y-3">
        <button
          ...
          className="w-full rounded-lg border border-line bg-card py-3 text-sm font-semibold text-ink transition hover:border-trust disabled:opacity-50"
        >
        ...
        {mode === "password" && (
          <div className="grid grid-cols-2 gap-1 rounded-lg border border-line bg-card p-1">
            <button
              type="button"
        ...
        {status === "check-email" ? (
          <div className="rounded-card border border-good/40 bg-card p-5">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full text-center text-sm text-trust hover:underline"
            >
