...
export type Message = {
  ...
  /** kind "image": the photo's path in the private chat-images bucket
   * (supabase/24-chat-images.sql) — signed into a URL at display time. */
  imageUrl?: string;
};
