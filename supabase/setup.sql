...
-- PART 5  self-service account deletion
-- PART 6  Stripe Connect Accounts v2 migration
-- =====================================================================
...
-- email link). SECURITY DEFINER is what lets this reach auth.users; the
-- auth.uid() check is what stops it from ever being used on anyone but
-- the caller.
--
