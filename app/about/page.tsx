  ...
  return (
    <div className="mx-auto max-w-[880px] px-4 py-14">
      ...
      <div className="mt-10 max-w-2xl">
        ...
        <h1 className="display mt-2 text-4xl sm:text-[48px]">{BRAND.tagline}</h1>
        <p className="mt-4 text-base leading-relaxed text-muted">{BRAND.blurb}</p>
      </div>
      ...
      <div className="mt-8 rounded-card border border-trust bg-trust-soft p-6 sm:p-7">
        <h2 className="text-xl font-semibold text-trust">No warehouse, no stock</h2>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-card border border-line bg-card p-6">
          <h2 className="text-base font-semibold">How the money works</h2>
