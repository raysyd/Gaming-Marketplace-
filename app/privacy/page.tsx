  ...
  return (
    <div className="mx-auto max-w-[880px] px-4 py-14">
      ...
      <div className="mt-10 max-w-2xl space-y-8">
        ...
        <section className="border-t border-line pt-6">
          <h2 className="text-[17px] font-semibold">Who we share it with</h2>
          <p className="mt-2 text-[14.5px] leading-relaxed text-muted">
        ...
        <section className="border-t border-line pt-6">
          <h2 className="text-[17px] font-semibold">Cookies and sessions</h2>
          <p className="mt-2 text-[14.5px] leading-relaxed text-muted">
        ...
        <section className="border-t border-line pt-6">
          <h2 className="text-[17px] font-semibold">How long we keep it</h2>
          <p className="mt-2 text-[14.5px] leading-relaxed text-muted">
